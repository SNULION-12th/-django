...
class PostListView(APIView):
    ...
    def get(self, request): 
        ...
        toJson = PostSerializer(posts, True)
        return Response(toJson, status=status.HTTP_200_OK)
    ...
    def post(self, request):
        ...
        #Post class의 객체 post는 그 자체로 JSON이 아니라 Post extends QuerySet 의 객체라서 (Python의 특징적인 클래스 Queryset) 바로 JSON으로 못씀
