...
class Post(models.Model):
    ...
    author = models.ForeignKey(User, null=True, on_delete=models.CASCADE) # 반대쪽에 자동으로 맵핑
    like_users = models.ManyToManyField(User,blank=True,related_name='like_posts',through='Like') # 반대쪽에 자동으로 맵핑
    tags = models.ManyToManyField(Tag, blank=True, related_name='posts') # 반대쪽에 자동으로 맵핑
